...
constexpr unsigned int MAX_MIXER_CHANNELS_SETTINGS_COUNT = MAX_MIXER_CHANNELS * 4;
...
constexpr unsigned int AUDIO_CHANNEL_COUNT = 2;
...
constexpr size_t FFT_FREQ_BUFFERS_BUFFER_SIZE = AUDIO_FRAMES_PER_BUFFER_MAX * AUDIO_CHANNEL_COUNT;
