...
: QWidget(parent)
  ...
  , cacheButton(new QPushButton(this))
  , filesButton(new QPushButton(this))
  , queueButton(new QPushButton(this))
  , filtersHeader(new QLabel(this))
  , clearFiltersButton(new QPushButton(this))
  , albumHeader(new QLabel(this))
  , albumClearFilterButton(new QPushButton(this))
  , artistHeader(new QLabel(this))
  , artistClearFilterButton(new QPushButton(this))
  , genreHeader(new QLabel(this))
