...
QVariant CacheQueryModel::data(const QModelIndex& item, const int role) const {
...
Result CacheQueryModel::setHeaders() {
  ...
  setHeaderData(AUDIO_FILE_COL_TRACK_NUMBER, Qt::Horizontal, QObject::tr("Track#"));
